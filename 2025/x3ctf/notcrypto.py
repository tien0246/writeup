...
# Fill these in with the actual values from your challenge:
byte_4050 = [
...
# Create inverse lookup for byte_4050
inv_4050 = [0] * 256
for x in range(256):
    inv_4050[byte_4050[x]] = x

# Process each 8-byte block from byte_2010
reversed_blocks = []
...
if padded_flag[-pad_len:] != bytes([pad_len] * pad_len):
